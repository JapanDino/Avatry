...
**Следующий шаг:** полноценные per-size меши (4.3, сейчас масштаб одного меша); реальные таблицы бренда (4.8); либо этап 5 (бэкенд/сохранение). Незакоммичена карта посадки (4.6).
