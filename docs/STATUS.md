...
**Следующий шаг:** 3D-карта посадки на аватаре (вершинные цвета по зонам, задача 4.6); полноценные per-size меши (4.3, сейчас масштаб одного меша); подстановка реальных таблиц бренда (4.8). Незакоммичен этап 4 + данные EN.
